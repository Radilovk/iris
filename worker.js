...
function createEnrichedVisionContext(interpretationKnowledge, maxEntries = 10) {
  ...
  if (contextEntries.length === 0) {
    contextEntries.push({
      ...
      summary:
        'Фокусирай се върху конституционалния анализ (цвят, структура, плътност) и пътищата за пречистване (черва, бъбреци, лимфа, бели дробове, кожа). Идентифицирай всички видими знаци: лакуни, нервни пръстени, radii solaris, пигменти, токсични пръстени.'
    });
  }
...
1. Системи, нуждаещи се от подкрепа
2. Пътища за пречистване (черва, бъбреци, лимфа, бели дробове, кожа)
...
**ИЗХОД (JSON):**
{
  ...
  "Пътища за пречистване": "Въвод + форматиран текст от signsInterpretation.eliminative_channels",
