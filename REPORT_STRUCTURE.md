...
```jsonc
{
  ...
  "dispositions": ["Предразположение 1", "Предразположение 2"],
  "signs": [{ "text": "Наблюдаван знак", "source": "Учебник по иридология" }],
  "recommendations": ["Обща насока", { "text": "Насока с източник", "source": "https://пример" }],
  "holistic_analysis": {
