...
- **Multi-Source Knowledge**: Комбинира RAG памет, LLM знания и опционално интернет търсене за максимална точност (виж [KNOWLEDGE_SOURCES.md](KNOWLEDGE_SOURCES.md))
- **Транспарентна аналитика**: Всеки доклад включва детайлни метрики за използваните източници и тяхното процентно разпределение
...
Системата използва 4 източника на знания за генериране на доклади:
1. **RAG Памет** (50%+) - Специализирана иридологична база данни
2. **База с препоръки** (20-25%) - Холистични терапии и протоколи
3. **Интернет търсене** (0-20%) - Опционални актуални източници
4. **LLM Знания** (25%) - AI синтеза и генериране

За детайли виж [KNOWLEDGE_SOURCES.md](KNOWLEDGE_SOURCES.md)
...
3. Worker-ът извиква AI модел за визуален анализ
4. Валидира и обогатява находките с RAG база данни
5. Генерира финален JSON доклад с аналитика за използваните източници
...
- [KNOWLEDGE_SOURCES.md](KNOWLEDGE_SOURCES.md) - Източници на знания и тяхното разпределение
