...
За да видите само `console.info` съобщенията от `handleAnalysisRequest`, в таба **Workers → Logs** използвайте:

```text
Message~"handleAnalysisRequest" AND Level="info"
```

Така лесно се откриват причините за ранните откази без активиран `DEBUG`.
