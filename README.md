...
**Брой AI заявки:**
- **Single-query режим** (по подразбиране): 3 заявки (2 за анализ на очите + 1 за доклад)
- **Multi-query режим**: 6 заявки (2 за анализ на очите + 4 стъпки за доклад)

Информацията за броя заявки се записва автоматично в `_analytics.ai_queries` секцията на генерирания доклад.
