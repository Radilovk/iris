...
## Лимити на AI моделите

- **OpenAI**: изображения до 20 MB; оптимален размер 2048×2048 px.
- **Gemini**: изображения до 20 MB; препоръчителна резолюция 2048–3072 px (максимум 4096 px).

Системата валидира локално файлове до 20 MB (чрез `MAX_IMAGE_BYTES`), което съвпада с лимита на API.

```js
const MAX_IMAGE_BYTES = 20 * 1024 * 1024;
if (file.size > MAX_IMAGE_BYTES) throw new Error("Прекалено голям файл");
```
